...
- Name tests after the behavior they verify, never after milestone numbers. Vitest is appropriate for focused coverage, but the behavior it covers must also be exercised through an end-to-end test.
