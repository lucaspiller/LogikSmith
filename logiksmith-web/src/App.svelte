<script lang="ts">
  ...
  async function refreshSnapshot(): Promise<void> {
    try { dispatch({ type: 'snapshot_loaded', snapshot: await loadSnapshot(), nowMs: Date.now() }); }
